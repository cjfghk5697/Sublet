	...
	return (
		<div>
			<div id="RomeInfo-ImgContainer" style={styles.RomeInfo_ImgContainer}>
				<img
					src={roomTempData[nowRomeNum].images[0]}
					alt=""
					style={styles.RomeInfo_ImgContainer_img}
				/>
				<div id="RomeInfo-ImgContainer2" style={styles.RomeInfo_ImgContainer2}>
					<div
						id="RomeInfo-MiniImgContainer"
						style={styles.RomeInfo_MiniImgContainer}>
						<img
							src={roomTempData[nowRomeNum].images[1]}
							alt=""
							style={styles.RomeInfo_MiniImgContainer_img}
						/>
						<img
							src={roomTempData[nowRomeNum].images[2]}
							alt=""
							style={styles.RomeInfo_MiniImgContainer_img}
						/>
					</div>
					<div
						...
						style={styles.RomeInfo_MiniImgContainer}>
						<img
							src={roomTempData[nowRomeNum].images[3]}
							alt=""
							style={styles.RomeInfo_MiniImgContainer_img}
						/>
						<img
							src={roomTempData[nowRomeNum].images[4]}
							alt=""
							style={styles.RomeInfo_MiniImgContainer_img}
						/>
					</div>
			...
			<div id="RomeInfo-detail" style={styles.RomeInfo_detail}>
				...
				<div id="detail refund">
					<h3>환불 정책</h3>
					<p>
						{roomTempData[nowRomeNum].refund_policy.split('\n').map(line => {
							return <p>{line}</p>;
						})}
					</p>
				</div>
