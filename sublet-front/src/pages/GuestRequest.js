...
import SearchPriceRange from '../components/HeaderComponents/SearchPriceRange.js';
...
function GuestRequest() {
  ...
  const {price, start_day, end_day, limit_people, number_room, number_bathroom, number_bedroom, accomodation_type, building_type, contract, city, gu, dong, alarm, school} = inputs;
      ...
      <div>
        ...
        <div style={styles.GuestRequest_Content}>		{/* 요청서 정보 입력 */}
            ...
            <Popover.Group style={styles.RequestBox}>
              ...
              <div style={styles.RequestBoxContainer2}>
                ...
                <FormControl sx={{m: 1, minWidth: 170}} size="small">
                  <InputLabel id="demo-simple-select-label">숙박 유형</InputLabel>
                  <Select
              ...
              <div>
                ...
                <div>
                  <FormControl sx={{m: 1, minWidth: 170}} size="small">
                    <InputLabel id="demo-simple-select-label">임대 종류</InputLabel>
                    <Select
                      name={'contract'}
                      value={contract}
                      label="contract"
                  ...
                  <FormControl sx={{m: 1, minWidth: 170}} size="small">
                    <InputLabel id="demo-simple-select-label">층수 이거 중복이어야하는데</InputLabel>
                    <Select
                      name={'number_room'}
                      value={number_room}
                      label="number_room"
                ...
                <div>
                  <FormControl sx={{m: 1, minWidth: 170}} size="small">
                    <InputLabel id="demo-simple-select-label">건물 유형</InputLabel>
                    <Select
                      name={'building_type'}
                      value={building_type}
                      label="building_type"
                ...
                <div>
                  <FormControl sx={{m: 1, minWidth: 170}} size="small">
                    <InputLabel id="demo-simple-select-label">욕실 개수</InputLabel>
                    <Select
                  ...
                  <FormControl sx={{m: 1, minWidth: 170}} size="small">
                    <InputLabel id="demo-simple-select-label">침실 개수</InputLabel>
                    <Select
                      name={'number_bedroom'}
          ...
          <div style={styles.GuestRequest_map}>
            {/* <img src={ } alt="nothing" style={styles.GuestRequest_map_img} /> */} {/* 임시 지도 이미지 */}
            <p> 이미지</p>
          </div>
        </div>
      </div>
...
function RequestPost({price, start_day, end_day, limit_people, number_room, number_bathroom, number_bedroom, accomodation_type, building_type, contract, city, gu, dong, alarm, school}) {
