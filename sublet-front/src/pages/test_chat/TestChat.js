      ...
      <ul>
        {rooms ? (
          rooms.map((room, index) => {
            return (
              <li key={index}>
                <Link to={`/test/chat/${room.room_id}`}>{room.room_id}</Link>{' '}
                {room.new_message ? (
