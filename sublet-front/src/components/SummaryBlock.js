...
function RequsetSummaryBlock({
	...
	const deleteHandle = () => {
		FetchDeleteRequest(request_key);
	};
			...
			<div name="respondDialog">
				<Dialog
					...
					<DialogContent className="text-left">
						{Post.length > 0 ? (
							<RequestByPostKeyInfo Post={Post} />
						) : (
							<p>아직 매칭이 되지 않았습니다.</p>
						)}
					</DialogContent>
			...
			<div className="mb-2 ml-3 col-span-4">
				...
				<div name="requestDialog">
					<Dialog
						...
						<DialogContent sx={{ width: 512 }} className="text-left">
							{request_list !== false && (
								<PostRequest request_list={request_list} />
							)}
						</DialogContent>
					</Dialog>
				</div>
